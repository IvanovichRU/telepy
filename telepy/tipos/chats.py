...
class ChatPrivado(Chat):
    ...
    def __init__(self, objeto: dict):
        super().__init__()
        self.usuario = '' # El nombre de usuario en chats privados o supergrupos.
        self.primer_nombre = '' # El primer nombre de la otra persona en un chat privado.
        self.apellido = '' # El apellido de la otra persona en un chat privado.
        self.bio = '' # El bio de la otra persona en un chat privado.

class Grupo(Chat):
    """Un grupo de Telegram en el cual puede haber hasta 200 miembros."""
    def __init__(self, objeto: dict):
        super().__init__()
        self.título = '' # El título para supergrupos, canales y grupos.
        self.descripción = '' # La descripción para grupos, supergrupos y canales.
        self.invitación = '' # El link de invitación para grupos, supergrupos y canales.
...
class SuperGrupo(Chat):
    ...
    def __init__(self, objeto: dict):
        ...
        self.nombre_set_stickers = '' # El nombre del set de stickers del supergrupo.
