class Audio:
    def __init__(self):
        ...
        self.id_única_archivo = '' # Identificador único para este archivo, para largo plazo.
        self.duración = 0 # La duración del audio en segundos.
        self.actor = '' # El actor que grabó el audio.
        self.título = '' # El título del audio.
        self.nombre_archivo = '' # El nombre original del archivo.
        self.tipo_mime = '' # El tipo de media MIME del archivo.
...
class FotoChat:
    def __init__(self):
        self.id_foto_pequeña = '' # Identificador de la foto pequeña del chat.
        self.id_único_foto_pequeña = '' # Identificador único del archivo de la foto pequeña del chat.
        self.id_foto_grande = '' # Identificador de la foto grande del chat.
        self.id_único_foto_grande = '' # Identificador único del archivo de la foto grande del chat.
...
class Vídeo:
    def __init__(self):
        ...
        self.miniatura = None # La miniatura del vídeo.
        self.nombre_archivo = '' # La miniatura del documento.
        self.tipo_mime = '' # El tipo de media MIME del archivo.
        self.tamaño_archivo = 0 # Tamaño del archivo.