class InfoWebhook:
    def __init__(self):
        self.url = 'Sin registrar' # URL del WebHook, puede estar vacía si el WebHook no fue preparado.
        ...
        self.dirección_ip = 'Sin registrar' # Dirección IP utilizada actualmente para el webhook.
